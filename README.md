...
## Notes
* In terms of simulation time, takes ~1-3 hours for small proteins like ubiquitin (8.6 kDa, 12.5 ns simulation time), ~3-4.5 hours for lysozyme (14 kDa, 15 ns simulation time), and ~6-12 hours for wheat agglutinin (35 kDa, 25 ns simulation time) using GPU acceleration. As droplets are all-interacting, Larger proteins can take **much** longer.
